...
export function TrustPage({ title, eyebrow, intro, sections }: { title: string; eyebrow: string; intro: string; sections: Array<{ title: string; body: string }> }) {
  return <main className="min-h-[70vh] bg-(--color-bg-deep) px-5 py-16 lg:px-8"><Card className="mx-auto max-w-3xl p-[clamp(24px,5vw,48px)]">
    <p className="text-xs font-bold uppercase tracking-widest text-(--color-brand-light)">{eyebrow}</p>
