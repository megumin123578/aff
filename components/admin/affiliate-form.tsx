  ...
  return (
    <form action={saveAffiliateLinkAction} className="space-y-5">
      <div className="grid gap-5 sm:grid-cols-2">
        ...
        <label className="flex items-center gap-3 self-end rounded-xl border border-(--color-border) bg-[var(--color-bg)] px-4 py-3 text-sm text-slate-300"><input type="checkbox" name="enabled" defaultChecked={link?.enabled ?? true} className="accent-[var(--color-brand)]" /> Enabled</label>
